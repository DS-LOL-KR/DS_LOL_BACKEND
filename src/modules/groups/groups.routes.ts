...
import { requireGroupMember, requireGroupOwner } from "../../middlewares/group.middleware"; // 그룹 멤버/그룹장만 허용하는 미들웨어
...
groupsRouter.get("/:id", authMiddleware, requireGroupMember, groupsController.getGroup);
...
groupsRouter.use("/:id/matches", authMiddleware, requireGroupMember, groupMatchesRouter);
